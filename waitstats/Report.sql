...
SELECT @bTime = '2014-05-27 10:45:00.000', @cTime = '', @eTime = '2014-05-27 11:45:00.000';
--SELECT @bTime = DATEADD(mi,-30,GETDATE()), @cTime = '', @eTime = GETDATE();

WITH Server_waits AS
	(
	SELECT [ServerName]
		  ...
		  ,[max_wait_time_ms]
		  ,[signal_wait_time_ms]
	  FROM [tempdb].[dbo].[tbltmp_wait_stats]
...
--		  ,sw2.[max_wait_time_ms] - sw1.[max_wait_time_ms] AS [max_wait_time_ms]
	...
	ORDER BY [TheTime] DESC, sw2.[wait_time_ms] - sw1.[wait_time_ms] DESC
